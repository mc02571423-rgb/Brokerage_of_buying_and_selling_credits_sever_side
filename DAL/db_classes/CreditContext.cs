...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost\\SQLEXPRESS;Database=credit;Trusted_Connection=True;TrustServerCertificate=True; Pooling=false");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CreditCode).HasName("PK__Zikuy_tb__69177F79F9C7C55E");
            ...
            entity.HasOne(d => d.StoreCodeNavigation).WithMany(p => p.ZikuyTbls)
                ...
                .HasConstraintName("FK__Zikuy_tbl__Store__3E52440B");
        });
